...
export default function Page() {
  ...
  return (
    <main className="bg-gradient-to-t from-blue-200 to-sky-50 flex flex-col gap-2 items-center py-20">
      <Confetti />
      <h1 className="text-3xl font-sour font-extrabold text-blue-800 m-2">
        Happy birthday, Mum!
      </h1>
